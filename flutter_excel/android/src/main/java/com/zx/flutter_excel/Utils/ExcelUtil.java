package com.zx.flutter_excel.Utils;
...
public class ExcelUtil {
     ...
     */
    public static boolean initExcel(String filePath, String sheetName, String[] colName) {
        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    list.add(String.valueOf(demoBean.getContent()));
